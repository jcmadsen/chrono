...
#include "chrono_vehicle/suspension/MultiLinkStrut.h"
...
// file.
// -----------------------------------------------------------------------------
MultiLinkStrut::MultiLinkStrut(const std::string& filename)
: ChMultiLinkStrut(""),
...
MultiLinkStrut::MultiLinkStrut(const rapidjson::Document& d)
: ChMultiLinkStrut(""),
  m_springForceCB(NULL),
  m_shockForceCB(NULL)
{
...
// -----------------------------------------------------------------------------
// Worker function for creating a MultiLinkStrut suspension using data in the
// specified RapidJSON document.
// -----------------------------------------------------------------------------
void MultiLinkStrut::Create(const rapidjson::Document& d)
{
  // Read top-level data
